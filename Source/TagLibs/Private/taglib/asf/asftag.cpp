...
static const char *AsfkeyTranslation[][2] = {
  { "WM/AlbumTitle", "ALBUM" },
...
PropertyMap ASF::Tag::properties() const
{
  ...
  if(keyMap.isEmpty()) {
    int numKeys = sizeof(AsfkeyTranslation) / sizeof(AsfkeyTranslation[0]);
    for(int i = 0; i < numKeys; i++) {
      keyMap[AsfkeyTranslation[i][0]] = AsfkeyTranslation[i][1];
    }
  }
...
PropertyMap ASF::Tag::setProperties(const PropertyMap &props)
{
  ...
  if(reverseKeyMap.isEmpty()) {
    int numKeys = sizeof(AsfkeyTranslation) / sizeof(AsfkeyTranslation[0]);
    for(int i = 0; i < numKeys; i++) {
      reverseKeyMap[AsfkeyTranslation[i][1]] = AsfkeyTranslation[i][0];
    }
  }
