...
static const StringHandler id3v1defaultStringHandler;
const ID3v1::StringHandler *ID3v1::Tag::TagPrivate::stringHandler = &id3v1defaultStringHandler;
...
void ID3v1::Tag::setStringHandler(const StringHandler *handler)
{
  if (handler)
    ...
    TagPrivate::stringHandler = &id3v1defaultStringHandler;
}
