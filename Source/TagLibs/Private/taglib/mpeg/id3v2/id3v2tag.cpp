...
static const Latin1StringHandler id3v2defaultStringHandler;
const ID3v2::Latin1StringHandler *ID3v2::Tag::TagPrivate::stringHandler = &id3v2defaultStringHandler;
...
void ID3v2::Tag::setLatin1StringHandler(const Latin1StringHandler *handler)
{
  if(handler)
    ...
    TagPrivate::stringHandler = &id3v2defaultStringHandler;
}
