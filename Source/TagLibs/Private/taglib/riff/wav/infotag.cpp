...
public:
  ...
  static const RIFF::Info::StringHandler *stringHandler;
};
...
TagLib::RIFF::Info::FieldListMap RIFF::Info::Tag::fieldListMap() const
{
...
void RIFF::Info::Tag::setFieldText(const ByteVector &id, const String &s)
{
  ...
  if(!InfoTag_Helper::isValidChunkID(id))
    return;
